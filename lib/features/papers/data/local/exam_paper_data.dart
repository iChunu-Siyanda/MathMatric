  ...
  Map<ExamSession, Map<String, List<ExamPaper>>> _getExamPaper(String type) => {
        ExamSession.march: {
          "march_${type}_2024": [
            ExamPaper(
                ...
                assetPath:
                    "march/2023_kzn", //assets/papers/paper_1/exams/papers/
            ...
            ExamPaper(
              ...
              assetPath: "march/2023_kzn", //assets/papers/paper_1/exams/memos/
              id: 'march_${type}_2023_memo_prov',
              isMemo: true,
              parentPaperId:
                  'march_${type}_2023_prov', // Same as id of question paper.
              isNational: false,
              pageCount: 8,
              session: ExamSession.march,
              year: 2024,
        ...
        ExamSession.june: {
          "june_${type}_2024": [
            ExamPaper(
                ...
                assetPath:
                    "june/2024_nat", //assets/papers/paper_1/exams/papers/
            ...
            ExamPaper(
                ...
                title: "${type.toUpperCase()} June 2024",
                assetPath:
                    "june/2024_prov", //assets/papers/paper_1/exams/papers/
            ...
            ExamPaper(
              ...
              assetPath: "june/2024_nat", //assets/papers/paper_1/exams/memos/
              id: 'june_${type}_2024_memo_nat',
              isMemo: true,
              parentPaperId:
                  'june_${type}_2024_nat', // Same as id of question paper.
              isNational: true,
              pageCount: 12,
              session: ExamSession.june,
              year: 2024,
            ...
            ExamPaper(
              //PROVINCIAL MEMO
              title: "${type.toUpperCase()} June 2024 Memo",
              assetPath: "june/2024_prov", //assets/papers/paper_1/exams/memos/
              id: 'june_${type}_2024_memo_prov',
              isMemo: true,
              parentPaperId:
                  'june_${type}_2024_prov', // Same as id of question paper.
              isNational: false,
              pageCount: 12,
              session: ExamSession.june,
              year: 2024,
        ...
        ExamSession.prelims: {
          "prelim_${type}_2025": [
            ExamPaper(
                ...
                assetPath: "prelim/2025_kzn", //papers/paper_1/exams/papers/
            ...
            ExamPaper(
              ...
              assetPath: "prelim/2025_kzn", //papers/paper_1/exams/memos/
              isMemo: true,
        ...
        ExamSession.november: {
          "november_${type}_2024": [
            ExamPaper(
                ...
                assetPath: "november/2024_nat", //papers/paper_1/exams/papers/
            ...
            ExamPaper(
                title: "${type.toUpperCase()} November 2024",
                assetPath: "november/2023_nat", //papers/paper_1/exams/papers/
            ...
            ExamPaper(
              ...
              assetPath: "november/2024_nat", //papers/paper_1/exams/memos/
              isMemo: true,
        ...
        ExamSession.ieb: {
          "ieb_${type}_2024": [
            ...
            ExamPaper(
              title: "${type.toUpperCase()} IEB November 2024",
              assetPath: "ieb/november_ieb/2024", //papers/paper_1/exams/memos/
              isMemo: true,
